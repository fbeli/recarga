...
public class ServicoAcessoRV {
	 ...
	 * @param codRetorno 0 confirma transa��o  | 1 Cancela transa��o
	 * @return
	...
	/**
	 * 
	 * @param idProduto C�digo do produto a ser utilizado
	 * @param ddd ddd do telefone a ser recarregado
	 * @param fone n�mero do telefone a ser recarregado
	 * @param usuarioLocal usu�rio que est� operando a m�quina, ou null
	...
	/**
	 * 
	 * @param codProduto M�ximo 9 posi��es.produto String C�digo do produto solicitado, de acordo com os valores retornados na transa��o 1
	 * @param uf
	 * @param usuarioLocal
	 * @param id_terminal
	 * @param idRecarga C�digo da Compra no sistema do cliente. Deve ser um sequencial �nico para cada transa��o (chave prim�ria do cliente - n�o pode se repetir). M�ximo 9 posi��es.
	 * @return
	 * @throws ErroException 
	 */
