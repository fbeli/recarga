...
public class RecarregarService<T> {
	 ...
	 */
	public List<Produto> buscarProdutosAtivosParaDDDeOperadora(String ddd, String idOperadora) throws ErroException{
	...
	/**
	 * Serviço responsável  pela conclusão ou cancelamento da recarga
	 * 
	...
	private Recarga criarRecarga(String codProduto, String ddd, String fone, 
			String IP,String usuario) throws ErroException{
	...
	/**
	 * Persistir recarga em banco
	 * @param recarga
	 * @return
	 * @throws ErroException
	 */
	private Recarga salvarRecarga(Recarga recarga) throws ErroException{
	...
	private Recarga updateRecarga(Recarga re, CellCardRecargaPin cellcard, StatusRecarga status) throws ErroException{
		if(cellcard!=null){
			if(status == StatusRecarga.SOLICITADO){
				re.setMensagem(cellcard.getMensagem());
				re.setCodOnline(cellcard.getCodOnline());
	...
	public Recarga getRecargaById(long id) throws ErroException{
		return hDaoRecarga.getRecargaPorId(id);
	}
	public Recarga getRecargaById(String id) throws  ErroException{
