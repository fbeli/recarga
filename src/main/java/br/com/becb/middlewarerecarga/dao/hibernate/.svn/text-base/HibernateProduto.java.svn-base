...
public class HibernateProduto<T> extends HBDAO<T> {
	...
	public Produto verificarProdutoExistente(Produto produto) throws ErroException {
	...
	public Produto getProdutoPorCodigo(String codProduto) throws ErroException{
	...
	public List<Produto> getTodosProdutos() throws ErroException{
	...
	public List<Produto> getProdutosDDDeOperadora(String ddd, String idOperadora) throws ErroException {
