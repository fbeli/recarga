...
<body>
	  ...
	  <div class="row-fluid">
        <div class="span9">
          <div class="hero-unit">
            <h1>Administração de Recargas</h1>
            <p>Área para adm, execução de relatórios e visualizações de recargas</p>           
          </div>
          ...
          <div class="row-fluid">
           ...
           <sec:authorize access="hasRole('ROLE_ADMIN') or hasRole('ROLE_SUPERVISOR')">
            ...
            <div class="span4">
              <h2>Verifica Transação Online </h2>
              <form id="formVerificaTransacao"
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <h2>Listar Transação por Usuários</h2>
            ...
            <div class="span4">
              <h3>Verifica Transação Pendente</h3> <br> <a
        href="<%=request.getContextPath()%>/admin/listarTransacaoPendente">
          Lista transações pendentes </a></td>
          <br><br>
